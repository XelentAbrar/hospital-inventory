  ...
  <div class="a4-size relative mx-auto flex flex-col rounded-lg shadow-md">
    <div class="bg-white overflow-hidden a4-size relative mx-auto shadow-sm rounded-lg">
      <div style="font-family: Arial, Helvetica, sans-serif; padding: 20px;display: flex;flex-direction: column;">
          ...
          <div style="display: flex;align-items: center;justify-content: space-between;flex: initial;width: 100%;margin: 5px auto;">
            <div style="width: 50%;">
              <div style="display: flex;align-items: center;">
                <h4 style="margin: 0;font-family: sans-serif; width: 100px;font-weight:600;font-size: 14px;">Receipt #</h4>
                <h4 style="margin:0 10px;font-weight:bold; width: 10px;text-align: center;">:</h4>
                <p style="margin: 0;margin-left: 2px;text-align: left;font-size: 14px;" >{{ goodsReceiptNote.goods_receipt_no }}</p>
              </div>
            </div>
            <div style="width: 50%;display: flex;justify-content: start;">
              <div style="display: flex;align-items: center;">
                ...
                <h4 style="margin:0 10px;font-weight:bold; width: 10px;text-align: center;">:</h4>
                <!-- <p style="margin: 0;margin-left: 2px;text-align: left;white-space: nowrap;font-size: 14px;">2024-08-19 08:09:47</p> -->
          ...
          <div style="display: flex;align-items: center;justify-content: space-between;flex: initial;width: 100%;margin: 5px auto;">
            <div style="width: 50%;display: flex;justify-content: start;">
              <div style="display: flex;align-items: center;">
                ...
                <h4 style="margin:0 10px;font-weight:bold; width: 10px;text-align: center;">:</h4>
                <p style="margin: 0;margin-left: 2px;text-align: left;font-weight: 500;font-size: 14px;" >{{ goodsReceiptNote?.inward_gatepass_id }}</p>
              </div>
            </div>
            <div style="width: 50%;display: flex;justify-content: start;">
              <div style="display: flex;align-items: center;">
        ...
        <div>
          <p style="font-size: 22px;font-weight: 600;text-align: center;margin: 10px 0;">GoodReceipt Detail</p>
        </div>
          ...
          <table class="min-w-full border-separate border-spacing-0 divide-y divide-gray-300 overflow-auto">
            <thead>
              <tr class="divide-x divide-gray-300">
                ...
                <th scope="col" class="bg-primary whitespace-nowrap text-center font-bold text_white border-b border-gray-300">Remarks</th>
              </tr>
            </thead>
            <tbody>
              <tr  class="odd:bg-gray-50 even:bg-white divide-x divide-gray-300" >
                <td class="whitespace-nowrap relative text-center border-b border-gray-300">{{ goodsReceiptNote.id }}</td>
                <td class="whitespace-nowrap relative text-center border-b border-gray-300">{{ goodsReceiptNote?.remarks }}</td>
              </tr>
