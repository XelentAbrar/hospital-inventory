<template>
  ...
  <AppLayout title="Expired Products">
    <div class="w-full mx-auto pt-6">
      <div class="bg-white shadow-sm rounded-lg">
        <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div class="flex flex-col md:flex-row items-start md:items-center justify-between no-print">
            <h1 class="font-semibold text-3xl text-primary">Expired Products</h1>
            <div class="mt-2 ml-auto sm:mt-0">
              <form
                @submit.prevent="report.get(route('inventory.expiry-product'), report)"
              >
            ...
            <div class="bg-white a4-size relative mx-auto shadow-sm rounded-lg">
              <div style="font-family: Arial, Helvetica, sans-serif; padding: 20px;display: flex;flex-direction: column;">
                <div class="print-only">
                    ...
                    <div style="display: flex;align-items: center;justify-content: space-between;flex: initial;width: 100%;margin: 10px auto">
                      <div style="width: 50%;">
                        <div style="display: flex;align-items: center;">
                          ...
                          <h4 style="margin:0 10px;font-weight:bold; width: 10px;text-align: center;">:</h4>
                          <p style="margin: 0;margin-left: 2px;text-align: left;font-weight: 500;"> {{ report.from_date }}
                        </p>
                        </div>
                      </div>
                      <div style="width: 50%;display: flex;justify-content: start;">
                  ...
                  <div>
                    <p style="font-size: 22px;font-weight: 600;text-align: center;margin: 10px 0;">Expiry Report</p>
                  </div>
                </div>
                  ...
                  <table class="min-w-full border-separate border-spacing-0 divide-y divide-gray-300 overflow-auto">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td class="whitespace-nowrap relative text-center border-b border-gray-300">
                          <!-- {{ report?.expiry_date }} -->
                          {{ new Date(report?.expiry_date).toLocaleDateString('en-GB').replace(/\//g, '-') }}
