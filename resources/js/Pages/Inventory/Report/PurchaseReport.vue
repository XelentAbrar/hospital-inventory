      ...
      <div class="bg-white shadow-sm rounded-lg">
        <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div class="flex flex-col md:flex-row items-start md:items-center justify-between no-print">
            <h1 class="font-semibold text-3xl text-primary">Purchase Report</h1>
            <div class="mt-2 ml-auto sm:mt-0">
              <form @submit.prevent="report.get(route('inventory.purchase-report'), report)">
                  ...
                  <div>
                    ...
                    <div class="mt-2">
                      <input
                        ...
                        name="search"
                        type="text"
                        placeholder="search with supplier"
            ...
            <div class="mt-6 flow-root" id="printData">
              ...
              <div class="print-only">
                ...
                <div>
                  <p style="font-size: 22px;font-weight: 600;text-align: center;margin: 10px 0;">Purchase Report</p>
                </div>
              </div>
                ...
                <table class="min-w-full border-separate border-spacing-0 divide-y divide-gray-300 overflow-auto">
                  <thead>
                    <tr class="divide-x divide-gray-300">
                      <th scope="col" class="bg-primary whitespace-nowrap text-center font-bold text_white border-b border-gray-300 sticky top-0 z-10">Sr#</th>
                      ...
                      <th scope="col" class="bg-primary whitespace-nowrap text-center font-bold text_white border-b border-gray-300 sticky top-0 z-10">Name</th>
                      <th scope="col" class="bg-primary whitespace-nowrap text-center font-bold text_white border-b border-gray-300 sticky top-0 z-10">Supplier Name</th>
                      <th scope="col" class="bg-primary whitespace-nowrap text-center font-bold text_white border-b border-gray-300 sticky top-0 z-10">Qty</th>
                      <th scope="col" class="bg-primary whitespace-nowrap text-center font-bold text_white border-b border-gray-300 sticky top-0 z-10">Tax</th>
                      <th scope="col" class="bg-primary whitespace-nowrap text-center font-bold text_white border-b border-gray-300 sticky top-0 z-10">Rate</th>
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td class="whitespace-nowrap relative border-b border-gray-300 text-center">
                        <!-- {{ report?.inward_gatepass?.date.split(' ')[0] }} -->
                        {{ new Date(report?.inward_gatepass.date).toLocaleDateString('en-GB').replace(/\//g, '-') }}
                      ...
                      <td class="whitespace-nowrap relative border-b border-gray-300">
                        {{ report?.inward_gatepass.supplier?.name }}
                      </td>
                      <td class="whitespace-nowrap relative border-b border-gray-300 text-center">
                        {{ formatNumber(report?.qty) }}
                      </td>
                      <td class="whitespace-nowrap relative border-b border-gray-300 text-center">
                        {{ formatNumber(report?.tax_rate) }}
                      </td>
                      <td class="whitespace-nowrap relative border-b border-gray-300 text-center">
                        {{ formatNumber(report?.price) }}
                      </td>
                      <td class="whitespace-nowrap relative border-b border-gray-300 text-center">
                        {{ formatNumber(parseFloat((report?.price * report?.qty) * (1 + (report?.tax_rate / 100))).toFixed(2)) }}
                    </td>
                    </tr>
                  </tbody>
                  <tfoot>
                    <tr class="divide-x divide-gray-300 bg-secondary text-black">
                          ...
                          <td class="whitespace-nowrap relative">
                            Total Purchases : {{ reports.length }}
                          </td>
                          <td class="whitespace-nowrap relative">
                          </td>
                          <td class="whitespace-nowrap relative">
                          ...
                          <td class="whitespace-nowrap relative">
                            {{ formatNumber(sum(reports, 'tax_rate', 'report')) }}
                          </td>
                          <td class="whitespace-nowrap relative">
                            {{ formatNumber(sum(reports, 'price', 'report')) }}
                          </td>
                          <td class="whitespace-nowrap relative">
                            {{ formatNumber(sumtotal(reports, 'report', 'totalAmount')) }}
                          </td>
                        </tr>
                  </tfoot>
                </table>
              ...
              <div class="print-only" style="position:absolute;bottom: 0;width: 100%;">
               <div class="text-black h-auto w-full flex items-center justify-end py-6 px-12 pt-14">
                <div>
                  ...
                  <h2 class="doctor-info text-lg text-center font-semibold">Authorized By</h2>
                </div>
               </div>
              </div>
              </div>
