<template>
  <Head title="Material Return Report" />
  <AppLayout title="Material Return Report">
    <div class="w-full mx-auto pt-6">
      <div class="bg-white shadow-sm rounded-lg">
        <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div class="flex flex-col md:flex-row items-start md:items-center justify-between no-print">
            <h1 class="font-semibold text-3xl text-primary">Material Return Report</h1>
            <div class="mt-2 ml-auto sm:mt-0">
              <form @submit.prevent="report.get(route('inventory.return-report'), report)">
...
<p v-if="projectType === 'hms'">Nawaz Town Sargodha Road, Faisalabad</p>
                  ...
                  <div class="border-dashed border-2 border-gray-400 rounded px-4 mt-3">
                    <div style="display: flex;align-items: center;justify-content: space-between;flex: initial;margin-top: 20px !important;width: 100%;margin: 10px auto;">
                      <div style="width: 50%;">
                    ...
                    <div style="display: flex;align-items: center;justify-content: space-between;flex: initial;width: 100%;margin: 10px auto">
                      ...
                      <div style="width: 50%;display: flex;justify-content: start;">
                        <div style="display: flex;align-items: center;">
                          ...
                          <h4 style="margin:0 10px;font-weight:bold; width: 10px;text-align: center;">:</h4>
                          <p style="margin: 0;margin-left: 2px;text-align: left;">                            {{ new Date(report?.to_date).toLocaleDateString('en-GB').replace(/\//g, '-') }}
</p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div>
                    <p style="font-size: 24px;font-weight: 600;text-align: center;margin: 0;margin-bottom: 20px;margin-top: 20px;">Return Report</p>
                  </div>
                </div>
                  ...
                  <table class="min-w-full border-separate border-spacing-0 divide-y divide-gray-300 overflow-auto">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td class="whitespace-nowrap relative text-center border-b border-gray-300">
                          <!-- {{ report?.material_return_note?.date }} -->
                          {{ new Date(report?.material_return_note.date).toLocaleDateString('en-GB').replace(/\//g, '-') }}
