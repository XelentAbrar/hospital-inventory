            ...
            <div class="mt-6 flow-root">
                ...
                <div class="pagination-container py-4 flex justify-between px-1">
                      <div class="pagination-info flex ">
                            Page <span class="font-semibold px-1 text-gray-900 report">{{ customers.current_page }}</span> of
                              <span class="font-semibold px-1 text-gray-900 report">{{ customers.last_page }}</span>
                            <div >
                              <p class="pagination-info">
                                Showing
                                <span class="font-semibold text-gray-900 report">{{ customers.from }}</span>
                                to
                                <span class="font-semibold text-gray-900 report">{{ customers.to }}</span>
                                of
                                <span class="font-semibold text-gray-900 report">{{ customers.total }}</span>
                                entries
                              </p>
                            </div>
                          </div>
                      ...
                      <div class="pagination-boxes">
                            <template v-if="customers.prev_page_url">
                                <InertiaLink
                                    :key="'prev'"
                            ...
                            <template v-for="page in customers.last_page">
                                <InertiaLink
                                    :key="`page-${page}`"
                                    v-if="page === customers.current_page"
                                    :href="
                            ...
                            <template v-if="customers.next_page_url">
                                <InertiaLink
                                    :key="'next'"
...
//     return Inertia.delete(route("customers.destroy", id));
//   }
Swal.fire({
        title: 'Are you sure?',
