          ...
          <form
              @submit.prevent="
                tax?.id
                  ...
                  : tax.post(route('taxes.store'), tax)
              "
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 py-6">
                  <div>
                    ...
                    >
                      ...
                      />
                    <InputError
                      v-if="tax.errors?.name"
                      :message="tax.errors?.name"
                    />
                  </div>
                  <div>
                    <label
                    ...
                    >
                      <input
                        ...
                        name="rate"
                        id="rate"
                        autocomplete="rate" step="0.01"
                        class="mt-1 block w-full rounded border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-sm sm:text-base h-11"
                        v-model="tax.rate"
                      />
                    <InputError
                      v-if="tax.errors?.rate"
                      :message="tax.errors?.rate"
                    />
                  </div>
                  <div class="sm:col-span-2">
                    ...
                    >
                      ...
                      />
                    <InputError
                      v-if="tax.errors?.description"
                      :message="tax.errors?.description"
                    />
                  </div>
                  <div>
                    <div class="mt-2">
                    ...
                    <InputError
                      v-if="tax.errors?.status"
                      :message="tax.errors?.status"
                    />
                  </div>
                </div>
...
const tax = useForm({
  id: props?.tax?.id || null,
  name: props?.tax?.name || null,
  rate: props?.tax?.rate || null,
  description: props?.tax?.description || null,
...
watch(enabled, (newValue) => {
  tax.status = newValue ? "active" : "inactive";
});
</script>
