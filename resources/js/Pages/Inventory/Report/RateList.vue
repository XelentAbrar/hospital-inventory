<template>
  <Head title="Rate List" />
  <AppLayout title="Rate List">
    <div class="w-full mx-auto pt-6">
      <div class="bg-white shadow-sm rounded-lg">
        <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div class="flex flex-col md:flex-row items-start md:items-center justify-between no-print">
            <h1 class="font-semibold text-3xl text-primary">Rate List</h1>
            <div class="mt-2 ml-auto sm:mt-0">
              <form
                @submit.prevent="report.get(route('inventory.rate-list'), report)"
              >
            ...
            <div class="bg-white a4-size relative mx-auto shadow-sm rounded-lg">
              <div style="font-family: Arial, Helvetica, sans-serif; padding: 20px;display: flex;flex-direction: column;">
                <div class="print-only">
                  ...
                  <div>
                    <p style="font-size: 22px;font-weight: 600;text-align: center;margin: 10px 0;">RateList Details</p>
                  </div>
                </div>
                  ...
                  <table class="min-w-full border-separate border-spacing-0 divide-y divide-gray-300 overflow-auto">
                    <thead>
                      <tr class="divide-x divide-gray-300">
                        <th scope="col" class="bg-primary whitespace-nowrap border-b border-gray-300 text-center font-bold text_white sticky top-0 z-10">
                          Sr#
                        </th>
                        <th scope="col" class="bg-primary whitespace-nowrap border-b border-gray-300 text-center font-bold text_white sticky top-0 z-10">
                          Name
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td class="whitespace-nowrap relative border-b border-gray-300">
                          {{ formatNumber(report?.product_name) }}
                        </td>
                        <td class="whitespace-nowrap relative text-center border-b border-gray-300">
